Vue.component('proselector', function (h, params) {
    axios.get('../Content/components/proselector/proselector.html').then(function (response) {
        h({
            ...
            methods: {
                ...
                Query: function () {
                    ...
                    axios.post('/Product/GetData', _self.Table.search).then(function (response) {
